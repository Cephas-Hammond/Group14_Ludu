...
public class Stat {
    ...
    static void display(Stage window){
        ...
        TextField userName = new TextField(SQLiteJDBC.getUserName());
        ...
        Text userID = new Text((""+SQLiteJDBC.getId()));
        Main.setFont(userID);
        ...
        Text gamesPlayed = new Text(""+SQLiteJDBC.getGames());
        ...
        Text wins = new Text(""+SQLiteJDBC.getWins());
        Main.setFont(wins);
        ...
        Text loss = new Text(""+SQLiteJDBC.getLosses());
        Main.setFont(loss);

        Button save = new Button("Save");
        save.setOnAction(e->{
            SQLiteJDBC.setUserName(userName.getText());
            userID.setText("p_"+ SQLiteJDBC.getUserName()+145);
            //SET ID UPDATE IN DB
        });
